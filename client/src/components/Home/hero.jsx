...
//   return (
//     <section className="px-6 bg-gradient-to-br from-amber-100 to-orange-100 py-6">
//       <div className="max-w-screen-xl mx-auto">
//         <div className="flex flex-col md:flex-row items-center justify-between min-h-[700px]">
//           {/* Left Content */}
