...
export default function ConsultantCard({ consultant, onViewProfile }) {
    const {
      name,
      primaryCategory,
      languageProficiency,
    ...
    return (
      <div className="bg-gray-50 w-[320px] rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="flex justify-center gap-3">
          ...
          <button className="px-6 py-2 rounded-lg text-white bg-teal-800 hover:bg-teal-900 transition-all duration-300">
            Book Now
          </button>
        </div>
      </div>
