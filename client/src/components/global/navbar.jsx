...
const Navbar = () => {
  return (
    <nav className=" w-full z-50 bg-transparent px-6 py-4 bg-gradient-to-tr from-orange-100 to-green-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* Sign Up Button */}
        <button className="bg-teal-900 text-white px-6 py-2 rounded-full font-medium hover:bg-teal-950 transition-colors">
          Sign Up
        </button>
      </div>
    </nav>
