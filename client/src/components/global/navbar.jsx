              ...
              {!userRole ? (
                ...
                <>
                  ...
                  <span className="text-sm font-medium text-gray-600">
                    Logged in as: <span className="capitalize font-semibold text-green-700">{userRole}</span>
                  </span>
                  <button
                    onClick={handleLogout}
                    className="bg-red-100 hover:bg-red-200 text-red-700 font-semibold px-4 py-2 rounded-full transition duration-300"
                  >
                    Logout
                  </button>
                </>
